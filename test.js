...
it('should filter 30 files', function (cb) {
    ...
    var expectedOutdatedFiles = [
        ...
        "css/fonts/fontstyle-11111111.min.css",
        ...
        "css/try-to-trip-regex-11111111.min.css",
